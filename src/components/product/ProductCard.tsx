...
export function ProductCard({ product, index = 0 }: ProductCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      {/* Image Container — buttons live here, NOT inside any <a> */}
      <div
      ...
      >
        {/* Image link — absolute base layer (z-0), no buttons inside */}
        ...
        {/* Wishlist button — z-10, sibling of Link, never inside <a> */}
        <button
        ...
        {/* Add to cart overlay — z-10, sibling of Link, never inside <a> */}
        <div
      ...
      {/* Product Info — separate Link, no buttons inside */}
